# Generated by Powerlevel10k configuration wizard on 2024-05-09 at 10:53 EDT.
...
typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR=$'\uE0B0'  # Rightward Powerline arrow
...
typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR=$'\uE0B2'
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=$'\uE0B0'  # Rightward Powerline arrow
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=81
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=81
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=81
 ...
 function my_git_formatter() {
  ...
  if [[ -n $P9K_CONTENT ]]; then
    # Use pre-existing content if available (e.g., "loading")
